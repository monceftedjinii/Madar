...
def employees_list(request):
	...
	print(f"[MESSAGING] Current user ID: {current_user_id}, Email: {request.user.email}")
	...
	for e in qs.order_by('id'):
		...
		# For messaging, include the User ID if available and exclude current user
		if for_messaging:
			try:
				...
				# Don't include employees without User accounts
				continue
