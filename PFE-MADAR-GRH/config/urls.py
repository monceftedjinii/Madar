...
urlpatterns = [
    ...
    path('api/gpec/me/', madar_views.my_gpec, name='api-gpec-me'),
    path('api/gpec/rh/', madar_views.rh_gpec, name='api-gpec-rh'),
    path('api/gpec/competencies/', madar_views.gpec_competencies, name='api-gpec-competencies'),
    path('api/gpec/employee-competencies/', madar_views.upsert_employee_competency, name='api-gpec-employee-competencies'),
    path('api/gpec/objectives/', madar_views.create_objective, name='api-gpec-objectives'),
    path('api/gpec/objectives/<int:pk>/progress/', madar_views.update_objective_progress, name='api-gpec-objectives-progress'),
    path('api/gpec/plans/', madar_views.create_development_plan, name='api-gpec-plans'),
