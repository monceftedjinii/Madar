...
urlpatterns = [
    ...
    path('api/employees/<int:pk>/terminate/', madar_views.terminate_employee, name='api-employees-terminate'),
    ...
    path('api/positions/create/', madar_views.create_position, name='api-positions-create'),
    path('api/positions/<int:pk>/delete/', madar_views.delete_position, name='api-positions-delete'),
    ...
    path('api/attendance/team/<int:employee_id>/', madar_views.attendance_employee_detail, name='api-att-employee-detail'),
    ...
    path('api/leaves/all/', madar_views.all_leaves_global, name='api-leaves-all-global'),
    ...
    path('api/absences/justify/', madar_views.submit_absence_justification, name='api-absences-justify'),
    path('api/absences/me/', madar_views.my_absence_justifications, name='api-absences-me'),
    path('api/absences/rh/', madar_views.rh_absences_global, name='api-absences-rh'),
    path('api/absences/<int:pk>/accept/', madar_views.rh_accept_justification, name='api-absences-accept'),
    path('api/absences/<int:pk>/refuse/', madar_views.rh_refuse_justification, name='api-absences-refuse'),
    ...
    path('api/documents/<int:pk>/preview/', madar_views.preview_document, name='api-documents-preview'),
    ...
    path('api/documents/<int:pk>/delete/', madar_views.delete_document, name='api-documents-delete'),
    ...
    path('api/evaluations/rh/', madar_views.rh_evaluations, name='api-evaluations-rh'),
    ...
    path('api/dashboard/rh/', madar_views.dashboard.get_rh_dashboard, name='api-dashboard-rh'),
